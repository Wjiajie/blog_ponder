...
const noteItems: NoteItem[] = [
  ...
  { title: '五级标题', link: '/notes/level5', level: 5, icon: 'fas fa-book' },
  { title: '六级标题', link: '/notes/level6', level: 6, icon: 'fas fa-book' },
  { title: '一级标题', link: '/notes/level1-2', level: 1, icon: 'fas fa-book' },
